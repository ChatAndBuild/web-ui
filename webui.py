...
def create_ui(config, theme_name="Ocean"):
    ...
    with gr.Blocks(
        ...
        with gr.Tabs() as tabs:
            with gr.TabItem("🔧 LLM Configuration", id=1):
                with gr.Group():
                    ...
                    llm_model_name = gr.Dropdown(
                        label="Model Name",
                        choices=utils.model_names['anthropic'],
            ...
            with gr.TabItem("⚙️ Agent Settings", id=2, visible=False):
                with gr.Group():
                    agent_type = gr.Radio(
                        ["org", "custom"],
                        label="Agent Type",
            ...
            # with gr.TabItem("📁 Configuration", id=8, visible=False):
            #     with gr.Group():
